...
name: ponytail
description: >
  Consider simplification when choosing an implementation in a coding task,
  before adding dependencies, abstractions, configuration, compatibility layers,
  or extra process, and when the user asks to simplify code. Prefer existing
  code, standard libraries, and platform features while meeting the full request.
  Not for ordinary Q&A, translation, prose, or discussion of the skill itself.
